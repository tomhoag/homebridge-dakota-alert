...
5. Update your configuration file.  See the example below or use the plugin settings.

### Using the plugin settings page:

Configure each alert with a GPIO pin and a corresponding name (e.g. 'Arrival').

### Editing the config.json file:

Add a section to `platforms` that looks like this:
